...
import com.example.wordbook.databinding.FragmentFirstTestBinding
...
class FirstTestFragment : Fragment() {
    ...
    companion object {
        fun newInstance() = FirstTestFragment()
    }

    private lateinit var viewModel: FirstTestViewModel
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater, R.layout.fragment_first_test, container, false)
        viewModel = ViewModelProvider(this).get(FirstTestViewModel::class.java)

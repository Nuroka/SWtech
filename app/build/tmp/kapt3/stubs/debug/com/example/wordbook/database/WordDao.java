...
public abstract interface WordDao {
    ...
    @org.jetbrains.annotations.Nullable
    @androidx.room.Query(value = "SELECT * FROM words WHERE day = :day ORDER BY id ASC")
    public abstract java.lang.Object getWordsOfDay(int day, @org.jetbrains.annotations.NotNull
    kotlin.coroutines.Continuation<? super java.util.List<com.example.wordbook.database.Word>> continuation);
}